...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (GreekLetter g : letterList) {
            //System.out.println(g.toString());  // next line is the same toString() is implicitly called
            System.out.println(g);
        }
        //letterList.forEach(System.out::println);   // another way of writing the above loop
    }
